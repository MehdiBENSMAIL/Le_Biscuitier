...
#include "Le_Biscuitier/TP_WeaponComponent.h"
...
// Cross Module References
	...
	LE_BISCUITIER_API UClass* Z_Construct_UClass_UTP_WeaponComponent();
	LE_BISCUITIER_API UClass* Z_Construct_UClass_UTP_WeaponComponent_NoRegister();
...
// End Cross Module References
	...
	{
		P_GET_OBJECT(ALe_BiscuitierCharacter,Z_Param_TargetCharacter);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	struct Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon_Statics
	{
		...
		{
			ALe_BiscuitierCharacter* TargetCharacter;
		};
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTP_WeaponComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon, "AttachWeapon" }, // 3578263895
	...
	template<> LE_BISCUITIER_API UClass* StaticClass<UTP_WeaponComponent>()
	{
		return UTP_WeaponComponent::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UTP_WeaponComponent);
	UTP_WeaponComponent::~UTP_WeaponComponent() {}
	struct Z_CompiledInDeferFile_FID_Le_Biscuitier_Source_Le_Biscuitier_TP_WeaponComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Le_Biscuitier_Source_Le_Biscuitier_TP_WeaponComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTP_WeaponComponent, UTP_WeaponComponent::StaticClass, TEXT("UTP_WeaponComponent"), &Z_Registration_Info_UClass_UTP_WeaponComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTP_WeaponComponent), 1269594195U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Le_Biscuitier_Source_Le_Biscuitier_TP_WeaponComponent_h_2879987179(TEXT("/Script/Le_Biscuitier"),
		Z_CompiledInDeferFile_FID_Le_Biscuitier_Source_Le_Biscuitier_TP_WeaponComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Le_Biscuitier_Source_Le_Biscuitier_TP_WeaponComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
